    ...
    <Section>
      <div className='w-full x-padding py-8 overflow-hidden lg:py-48 flex flex-col lg:flex-row lg:justify-between space-y-8 lg:space-y-0'>
        ...
        >
          ...
          >
            Blockprint is a tool for determining which consensus clients produced which blocks on
            the Ethereum mainnet.
          </Typography>
          <Typography
            className='leading-5 lg:leading-6 max-w-lg lg:text-base1'
            type='text-base'
            color='text-light80'
          >
            It uses machine learning to guess the consensus client for a block, based on the
            similarity of that block to others in its training data. E.g. when blockprint saw the
            block at slot 6505122, it determined that this block was most likely produced by Prysm.
          </Typography>
        </motion.div>
        <motion.div
        ...
        >
          <motion.div
            ...
            transition={{ ...UP_ANIM.transition, delay: 0.3 }}
          >
            <Typography isBold type='text-base1'>
              How does it work?
            </Typography>
          </motion.div>
