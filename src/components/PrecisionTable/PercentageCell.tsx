      ...
      <td>
        <div className='flex items-center pr-5'>
          <div className='w-24 md:w-32 px-4 py-3'>
            <Typography className='md:text-base' type='text-xs'>
              {client}
            </Typography>
            <Typography type='text-xs' className='md:hidden' color='text-light80'>
              {percentage} %
            </Typography>
          </div>
          <PercentageFill percentage={value} />
          <div className='w-16 hidden md:block'>
            <Typography type='text-xs' color='text-light80' className='text-right'>
              {percentage} %
            </Typography>
          </div>
        </div>
